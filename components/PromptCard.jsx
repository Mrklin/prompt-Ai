...
const PromptCard = ({prompt, handleTagClick, handleEdit, handleDelete}) => {
    ...
    const handleProfileClcik = () => {
      //if the user click on his profile then go to my profile page otherwise go to other user's profile page 
